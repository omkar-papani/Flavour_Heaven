      ...
      <div className='w-full bg-bgColor h-full flex lg:flex-nowrap sm:flex-wrap flex-wrap justify-around py-4'>
            <div className='bg-darkbg p-4 rounded-xl w-fit m-2 container'>
                ...
                <div className='flex flex-wrap md:flex-wrap justify-center w-fit gap-3 '>
                    <div className='flex flex-col border p-6 lg:p-3 xl:p-6 bg-white 2xl:w-80 xl:w-64 lg:w-56 sm:w-64 w-64 rounded-xl card'>
                      <img src="https://www.themealdb.com/images/media/meals/wuxrtu1483564410.jpg"
                        className='2xl:w-72 2xl:h-72 xl:w-60 xl:h-60 lg:w-56 lg:h-56 sm:w-60 sm:h-60 w-60 h-60 place-self-center'
                      alt="" srcset="" />
