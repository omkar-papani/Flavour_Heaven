    ...
    {data && data.length > 0 ? (
        data.map(({strMeal, strMealThumb, idMeal, strCategory, strArea}) =>{
           const id = {idMeal}
            return(
            <>
                <div key={idMeal} className='flex flex-col border p-6 bg-white 2xl:w-96 xl:w-80 lg:w-72 md:w-56 sm:w-[30%] w-[48%] rounded-xl'>
                    <img src={strMealThumb} alt={strMeal}  className='2xl:w-80 2xl:h-80 xl:w-72 xl:h-72 lg:w-60 lg:h-60 md:w-48 md:h-48 sm:w-40 sm:h-40'/>
